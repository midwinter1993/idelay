...
public class MonitorExit extends Expr {
   protected MonitorExit(int pos, int adjustedPos, CodeIterator i, CtClass declaring, MethodInfo m) {
   ...
   public void replace(String statement) throws CannotCompileException {
      ...
      try {
         ...
         jc.recordProceed(new MonitorExit.Proceed(paramVar));
   ...
   static class Proceed implements ProceedHandler {
      ...
      public void doit(JvstCodeGen gen, Bytecode bytecode, ASTList args) throws CompileError {
         if (args != null && !gen.isParamListName(args)) {
            throw new CompileError("$proceed() cannot take a parameter for monitor exit");
         } else {
